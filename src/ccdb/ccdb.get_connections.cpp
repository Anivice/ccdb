...
//         const auto sort_by_from_watcher = sort_by_from_watcher_.load();
...
//                 sort_by_final = sort_by;
//             } else {
//                 sort_by = sort_by_from_watcher;
//                 sort_by_final = sort_by_from_watcher;
//             }
//
//             sort_by_from_watcher_ = -1;
//         }
//
//         int index_title = 0;
...
//             }
//
//             const bool skip_due_to_shrink = (vector_size_last_time > table_vals.size() || skip_lines_before < current_skip_lines);
...
//                     }
//
//                     if (leading_spaces_ != local_leading_spaces && leading_spaces_ < max_leading_spaces) {
//                         lock_to_max = false;
//                     }
//
//                     break;
