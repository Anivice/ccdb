...
void general_info_pulling::update_from_traffic(std::pair < std::mutex, std::string > & info)
{
    try {
...
void general_info_pulling::update_from_connections(std::pair < std::mutex, std::string > & info)
{
